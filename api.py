...
pairs = [
    [r"ฉัน ชื่อ (.*)", ["สวัสดี %1, สบายดีมั้ย"]],
    [r"hi|hey|hello|สวัสดี|สบายดี", ["สวัสดีเจ้า", "ยินดีที่ได้รู้จัก"]],
    [r"คุณ ชื่อ (.*)", ["ฉันชื่อปอน"]],
    [r"สถานที่ ท่องเที่ยว บางแสน", ["หาดบางแสน"]],
    [r"ร้าน ที่ อร่อย ที่สุด ใน ม   บูรพา", ["กะเพราบัง"]],
    [
...
async def line_webhook(data: LineRequest):
    for event in data.events:
        if event["type"] == "message" and event["message"]["type"] == "text":
            ...
            if response is None:
                response = (
                    "ไม่เข้าใจ กรุณาถามใหม : ตัวอย่างคำถาม มีสาขาอะไรบ้าง แต่ละหลักสูตรมีอะไรบ้าง"
                )
